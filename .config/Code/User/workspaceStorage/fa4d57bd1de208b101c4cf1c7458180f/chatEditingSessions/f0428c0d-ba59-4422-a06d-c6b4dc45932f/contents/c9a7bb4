...
#custom-title("Experience")[  
  #work-heading(
    ...
    - Engineered responsive eCommerce platform utilizing Nuxt.js (Vue.js SSR/SSG) with real-time inventory management, enhancing user experience and conversion optimization
    - Designed business intelligence dashboards using JavaScript frameworks and complex SQL queries to provide actionable insights on KPIs, sales analytics, and revenue forecasting
  ]
  ...
  #work-heading(
    ...
    - Performed thermal modeling and CFD simulations using IES VE and Carrier HAP to calculate heat load analysis and optimize HVAC system design for energy efficiency
  ]
]
...
#custom-title("Projects")[
  #project-heading(
    ...
    - Applied quantitative methodologies including financial modeling, Monte Carlo simulations, NPV/IRR calculations, and sensitivity analysis to evaluate project viability and ROI projections
  ]
  #project-heading(
...
#custom-title("Technical Skills")[
  #skills()[
    ...
    - *Web Development:* Nuxt.js, Vue.js, SvelteKit, Node.js, RESTful APIs, SSR/SSG
