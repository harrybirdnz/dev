...
// Remove zero-width spaces and other invisible characters from a string
...
// Sanitize only string values in an object while preserving structure
...
async function printInvoice() {
    ...
    const sanitizedInvoice = sanitizeInvoiceData(invoice.value);
...
async function printPicklist() {
    ...
    const sanitizedInvoice = sanitizeInvoiceData(invoice.value);
    const sanitizedComponents = sanitizeInvoiceData(invoice.value.picklist_components);
