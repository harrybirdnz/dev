-- Active: 1759808189054@@odoo-server@5432@rocersa-test
...
WHERE type IN ('kitset')
  AND name_metric IS NOT NULL AND name_metric <> ''
  AND weight IS NOT NULL
  AND au_wholesale_cost IS NOT NULL
  AND categories.group IN ('Corten Kitsets', 'Corten')
